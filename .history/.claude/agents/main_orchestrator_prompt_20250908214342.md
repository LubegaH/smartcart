...
- **Backend Engineer** (`backend_engineer_prompt`): Database, APIs, security policies, RLS
- **Frontend Engineer** (`frontend_engineer_prompt`): React components, PWA features, mobile-first UI
- **Code Reviewer** (`code_reviewer_prompt`): Quality gates, TypeScript compliance, architecture validation
- **QA & E2E Engineer** (`qa_e2e_engineer_prompt`): Testing, performance budgets, accessibility validation
- **Docs Agent** (`docs_agent_prompt`): Documentation sync, API docs, setup guides
