...
- **Best Practice**: Review `CLAUDE.md` for best coding practice and design decisions
...
- **Minimum**: 44x44px all touch targets
- **Spacing**: 8px between targets
- **Gestures**: Implement swipe, long-press where appropriate
...
- Push notification handlers (where applicable)
