    ...
    <div className='min-h-screen bg-gray-50'>
      <div className='max-w-4xl mx-auto px-4 py-6 pb-nav'>
        ...
        <nav className='flex items-center space-x-2 text-sm text-gray-500 mb-4'>
          ...
          <span className='text-gray-900 font-medium'>Retailers</span>
        </nav>
        ...
        <RetailerList
          ...
          emptyStateAction={
            <Button
              ...
              aria-label='Add your first retailer'
            >
              <HiPlus className='w-5 h-5 mr-2 flex-shrink-0' aria-hidden='true' />
              <span className='font-medium'>Add your first retailer</span>
            </Button>
          }
        />
      </div>
