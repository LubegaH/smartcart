    ...
    <div className="bg-white rounded-xl overflow-hidden">
      ...
      <div className="border-b border-gray-200 px-6 py-6">
        <div className="flex items-center mb-2">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center mr-3 ${retailer ? 'bg-blue-100 text-blue-600' : 'bg-emerald-100 text-emerald-600'}`}>
        ...
        <p className="text-gray-600">
          {retailer 
            ? 'Update retailer information to keep your store list current' 
            : 'Add a new store where you shop to start tracking prices and organizing trips'
          }
        </p>
      </div>
        ...
        {submitError && (
          <div className="rounded-md border border-red-200 bg-red-50 p-4">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="text-sm font-medium text-red-800">Unable to save retailer</h4>
