    ...
    return (
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm text-center py-16">
        <div className="max-w-sm mx-auto">
          <div className="w-20 h-20 rounded-full flex items-center justify-center bg-emerald-100 text-emerald-600 mx-auto mb-6">
  ...
  return (
    <div className="space-y-6">
      ...
      {filteredAndSortedRetailers.length === 0 ? (
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm text-center py-12">
          <div className="w-16 h-16 rounded-full flex items-center justify-center bg-blue-100 text-blue-600 mx-auto mb-4">
